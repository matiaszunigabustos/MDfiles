...
if {[llength $argv] != 4} {
    puts "Usage: vmd -dispdev text -e RMSD_traj.tcl -args psf traj resname fileout"
    exit
}

foreach {psf traj resname fileout} $argv { break }
...
set reference_mol [atomselect top "noh resname $resname" frame 0]
...
for {set frame 0} {$frame < $num_steps} {incr frame} {
	...
	set unk_actual [atomselect top "noh resname $resname" frame $frame]
        # compute the RMSD
